"""
Django settings for gendiStore project.
...
SECRET_KEY = '09^=le#vd@4eqgdr*zl5@z)z6snb)u0nn%q=*j)52y+s%uuj2o'
...
WSGI_APPLICATION = 'gendiStore.wsgi.application'
